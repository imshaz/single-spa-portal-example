...
async function init() {
  ...
  loadingPromises.push(
    loadApp("app3", "/app3", "/app3/singleSpaEntry.js", null, null)
  ...
  //   TODO: update this for app6
  // app6: The URL "/app6/..." is being redirected to "http://localhost:9006/..." this is done by the webpack proxy (webpack.config.js)
  loadingPromises.push(
    loadApp(
      "app6",
      "/app6",
      "/app6/singleSpaEntry.js",
      "/app6/store.js",
      globalEventDistributor
    )
  );
